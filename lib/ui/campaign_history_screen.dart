              ...
              ? const Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 16),
                      Text('Nenhuma campanha enviada ainda.', style: TextStyle(color: Colors.grey)),
                    ],
                  ),
                )
              : ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Card(
                      ...
                      child: ListTile(
                        ...
                        subtitle: Text('$dateStr • ${log.contacts.length} contatos'),
      ...
      builder: (context) => DraggableScrollableSheet(
        ...
        builder: (context, scrollController) => Container(
          ...
          child: Column(
            ...
            children: [
              Text('Detalhes da Campanha', style: Theme.of(context).textTheme.headlineSmall),
              const SizedBox(height: 8),
              Text(dateStr, style: TextStyle(color: Theme.of(context).colorScheme.outline)),
              ...
              Text('Enviado para (${log.contacts.length}):', style: const TextStyle(fontWeight: FontWeight.bold)),
              const SizedBox(height: 8),
              Expanded(
