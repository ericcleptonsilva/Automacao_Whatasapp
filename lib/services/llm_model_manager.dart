...
class LLMModelManager {
  ...
  Future<void> downloadModel(String url, {required Function(double) onProgress, String? token}) async {
    try {
      ...
      if (e is DioException) {
        ...
        LoggerService.log("LLMDownloadError: Access Denied (401/403).");
          throw Exception("Acesso Negado (401/403). O Token inserido é inválido, expirou ou você não aceitou os termos no site.");
        } else if (e.response != null && e.response!.statusCode == 404) {
          throw Exception("Erro 404: O link não foi encontrado. Verifique se copiou a URL exata do arquivo.");
        }
      }
