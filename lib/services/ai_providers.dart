  ...
  Future<String?> generateReply(
    ...
    try {
      ...
      final List<Map<String, String>> messages = [
        ...history.map(
          (e) => {
            'role': (e['role'] == 'model' || e['role'] == 'assistant')
                ? 'assistant'
                : 'user',
            'content': e['message'] ?? '',
          },
      ...
      if (response.statusCode == 200) {
        ...
        if (response.statusCode == 429)
          return "Erro 429: Limite de uso atingido no Claude.";
  ...
  Future<String?> generateReply(
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        LoggerService.log(
          "DeepSeek Error: ${response.statusCode} - ${response.body}",
        );
        if (response.statusCode == 429)
          return "Erro 429: Limite de uso atingido no DeepSeek.";
  ...
  Future<String?> generateReply(
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (response.statusCode == 429)
          return "Erro 429: Limite de requisições excedido no Groq.";
  ...
  Future<String?> generateReply(
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (response.statusCode == 429)
          return "Erro 429: Limite de uso atingido no Mistral.";
  ...
  Future<String?> generateReply(
    ...
    try {
      ...
      final response = await http
          .post(
            ...
            headers: {
              ...
              'Authorization': 'Bearer $apiKey',
              'HTTP-Referer':
                  'https://github.com/clept/automacao-whatsapp', // OpenRouter recommend sending this
          ...
          ); // OpenRouter acts as proxy and is often slower sometimes
      ...
      if (response.statusCode == 200) {
        ...
        if (response.statusCode == 429)
          return "Erro 429: Limite de uso atingido na OpenRouter para sua conta (ou modelo sem slots disponíveis).";
